...
* The original package name 'com.harmansahota.tutorials-redis-api' is invalid and this project uses 'com.harmansahota.tutorialsredisapi' instead.
...
```
$ docker run --rm -p 8080:8080 tutorials-redis-api:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/tutorials-redis-api
```
